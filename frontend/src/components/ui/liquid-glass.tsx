...
// Export sub-components for reuse throughout the app
export { GlassEffect, GlassDock, GlassButton, GlassFilter };
export type { GlassEffectProps, DockIcon };

// Legacy wrapper for backward compatibility
export default function LiquidGlassWrapper({ children, className = '' }: { children: React.ReactNode, className?: string }) {
    return (
        <GlassEffect className={className}>
            {children}
        </GlassEffect>
    );
}
