  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      draw(context: CanvasRenderingContext2D) {
        // Additive blending for brightness — much faster than shadowBlur
        context.globalCompositeOperation = "lighter";
        
        // Calculate dynamic alpha based on age
        const baseAlpha = 1 - Math.abs((this.age / this.life) - 0.5) * 2;
        
        // 1. Draw outer glow (faint large circle)
        ...
        // 2. Draw core particle (smaller bright circle)
        context.globalAlpha = baseAlpha * 1.0;
        context.beginPath();
